...
namespace AMLToolkit.ViewModel
{
    ...
    public static class AMLTreeViewTemplate
    {
        ...
        /// </list>
        /// </summary>
        public static List<string> CompleteSystemUnitClassLibTree = new List<string> {
        ...
        /// </list>
        /// </summary>
        public static List<string> ExtendedRoleClassLibTree = new List<string> {
        ...
        /// </list> 
        /// </summary>
        public static List<string> ExtendedSystemUnitClassLibTree = new List<string> {
            CAEX_CLASSModel_TagNames.SYSTEMUNITCLASSLIB_STRING,
            CAEX_CLASSModel_TagNames.SYSTEMUNITCLASS_STRING,
            CAEX_CLASSModel_TagNames.INTERNALELEMENT_STRING,
            CAEX_CLASSModel_TagNames.EXTERNALINTERFACE_STRING };
        ...
        /// </list> 
        /// </summary>
        public static List<string> InterfaceClassLibTree = new List<string> {
        ...
        /// </list>
        /// </summary>
        public static List<string> SimpleRoleClassLibTree = new List<string> {
            CAEX_CLASSModel_TagNames.ROLECLASSLIB_STRING,
            CAEX_CLASSModel_TagNames.ROLECLASS_STRING };
        ...
        /// </list> 
        /// </summary>
        public static List<string> SimpleSystemUnitClassLibTree = new List<string> {
            CAEX_CLASSModel_TagNames.SYSTEMUNITCLASSLIB_STRING,
            CAEX_CLASSModel_TagNames.SYSTEMUNITCLASS_STRING };
